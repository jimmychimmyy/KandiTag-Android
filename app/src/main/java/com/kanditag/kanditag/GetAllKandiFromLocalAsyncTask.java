 ...
 */
public class GetAllKandiFromLocalAsyncTask extends AsyncTask<Void, Void, ArrayList<KandiObject>> {
    ...
    public GetAllKandiFromLocalAsyncTask(Context context, ReturnKandiObjectArrayAsyncResponse response) {
